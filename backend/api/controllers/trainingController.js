...
const entrenamientoRed = async (req, res, next) => {
    ...
    try {
        ...
        const selectedClusteringObj = matricesClus.find(c => c.id_clustering === selectedClustering);
        ...
        trainingForm.append('matriz_clustering', JSON.stringify(selectedClusteringObj), {
